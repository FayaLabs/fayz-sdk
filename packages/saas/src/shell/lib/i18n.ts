...
export const defaultTranslations: Record<string, string> = {
  ...
  // ---------------------------------------------------------------------------
  // Entitlements — upgrade prompts, plan limits, soft-limit banner
  // ---------------------------------------------------------------------------
  ...
  'limit.reached': "You've reached the {label} limit of the {plan} plan.",
  'banner.overLimit': "You've exceeded the {label} limit of your plan — upgrade to keep growing.",
  'billing.featureMatrix': 'Feature comparison',
  'billing.unlimited': 'Unlimited',
  'billing.upTo': 'Up to {count}',
  // Limit labels — apps/plugins may override per key; these cover the base caps.
  ...
  'notes.emptyHint': 'Create your first note with the + button',
  'notes.noResults': 'Nothing found',
  'notes.emptyNote': 'Empty note',
  'notes.placeholder': 'Write something… (markdown works: # title, - [ ] checklist, **bold**)',
  ...
  'notes.todos': 'Tasks',
  'notes.addTodo': 'Add a task…',
  'notes.delegateNote': 'Chat with AI',
  'notes.delegateNote.prompt': 'Take over this note and resolve it: analyze the content, execute whatever is actionable with your tools, and report back what you did and what is pending.',
  'notes.delegateTodo': 'Chat with AI',
  'notes.delegateTodo.prompt': 'Take over this task and resolve it now, using your tools when needed. Bring me the result:',
  'notes.delegateTodo.from': 'from note',
  'chat.whatsapp.continue': 'Continue on WhatsApp',
  'chat.whatsapp.defaultMessage': 'Hi! I want to continue my conversation with the assistant.',
...
export const builtInLocales: Record<string, Record<string, string>> = {
  'pt-BR': {
    ...
    'notes.back': 'Notas',
    'notes.new': 'Nova nota',
    'notes.untitled': 'Nova nota',
    'notes.search': 'Buscar notas…',
    'notes.empty': 'Nenhuma nota ainda',
    'notes.emptyHint': 'Crie sua primeira nota com o botão +',
    'notes.noResults': 'Nada encontrado',
    'notes.emptyNote': 'Nota vazia',
    'notes.placeholder': 'Escreva algo… (markdown funciona: # título, - [ ] checklist, **negrito**)',
    'notes.created': 'Criada',
    ...
    'notes.confirmDelete': 'Excluir?',
    'notes.todos': 'Tarefas',
    'notes.addTodo': 'Adicionar tarefa…',
    'notes.delegateNote': 'Conversar com IA',
    'notes.delegateNote.prompt': 'Assuma esta nota e resolva: analise o conteúdo, execute o que for acionável com suas ferramentas e me devolva o que fez e o que ficou pendente.',
    'notes.delegateTodo': 'Conversar com IA',
    'notes.delegateTodo.prompt': 'Assuma esta tarefa e resolva agora, usando suas ferramentas quando precisar. Me devolva o resultado:',
    'notes.delegateTodo.from': 'da nota',
    'chat.whatsapp.continue': 'Continuar no WhatsApp',
    'chat.whatsapp.defaultMessage': 'Olá! Quero continuar minha conversa com o assistente.',
    ...
    // Entitlements — upgrade prompts, limites de plano, banner de soft-limit
    ...
    'billing.featureMatrix': 'Comparação de recursos',
