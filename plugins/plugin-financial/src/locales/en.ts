...
export const en: Record<string, string> = {
  "financial.cards.addExpense": "Add expense",
  "financial.cards.allBillsValue": "All bills value",
  "financial.cards.availableLimit": "Available limit",
  "financial.cards.currentBill": "Current bill",
  "financial.cards.dueOn": "Due on the {{day}}",
  "financial.cards.installment": "Installment {{current}}/{{total}}",
  "financial.cards.noCards": "No cards yet",
  "financial.cards.noCardsHint": "Add a credit card in settings to track your bills here",
  "financial.cards.noTransactions": "No card transactions",
  "financial.cards.tabClosed": "Closed",
  "financial.cards.tabOpen": "Open",
  "financial.cards.usedOfLimit": "{{percent}}% of limit used",
  ...
  "financial.invoice.filterAccount": "Chart account",
  "financial.invoice.filterAllAccounts": "All accounts",
  "financial.invoice.filterCostCenter": "Cost center",
  "financial.invoice.filterAllCostCenters": "All cost centers",
  "financial.invoice.filterPeriod": "Period",
  "financial.invoice.filterAllPeriods": "All time",
  "financial.invoice.filterThisMonth": "This month",
  "financial.invoice.filterLastMonth": "Last month",
  "financial.invoice.filterLast30": "Last 30 days",
  "financial.invoice.filterThisYear": "This year",
  "financial.invoice.filterCustom": "Custom",
  "financial.invoice.filterFrom": "From",
  "financial.invoice.filterTo": "To",
  "financial.invoice.filterClear": "Clear",
  "financial.reconciliation.title": "Reconciliation",
  "financial.reconciliation.subtitle": "Match imported bank lines to your movements",
  "financial.reconciliation.pending": "{{count}} to reconcile",
  "financial.reconciliation.allDone": "All caught up",
  "financial.reconciliation.empty": "Nothing to reconcile",
  "financial.reconciliation.emptyHint": "Imported bank transactions will appear here for matching.",
  "financial.reconciliation.bankLines": "Bank lines",
  "financial.reconciliation.candidates": "Suggested matches",
  "financial.reconciliation.selectLine": "Select a bank line to see suggested matches",
  "financial.reconciliation.noCandidates": "No suggested matches for this line",
  "financial.reconciliation.match": "Match",
  "financial.reconciliation.accept": "Accept as new",
  "financial.reconciliation.acceptHint": "No internal counterpart — keep as a standalone entry",
  "financial.reconciliation.matchScore": "{{score}}% match",
  "financial.reconciliation.refresh": "Refresh",
  ...
  "financial.payment.noAccounts": "No compatible account. Create one in Settings.",
  "financial.payment.configureAccounts": "Set up accounts",
  ...
  "financial.summary.today": "Today",
  "financial.summary.yesterday": "Yesterday",
  "financial.summary.transactionsTitle": "Transactions",
  "financial.home.balance": "Balance",
  "financial.home.inflow": "Income",
  "financial.home.outflow": "Expenses",
  "financial.home.showBalance": "Show balance",
  "financial.home.hideBalance": "Hide balance",
  "financial.home.upcomingBills": "Upcoming bills",
  "financial.home.noBills": "No upcoming bills.",
  "financial.home.dueToday": "Due today",
  "financial.home.dueTomorrow": "Due tomorrow",
  "financial.home.dueInDays": "Due in {{count}} days",
  "financial.home.overdueDays": "Overdue by {{count}} days",
  "financial.home.cards": "Cards",
  "financial.home.currentBill": "Current bill",
  "financial.home.availableLimit": "Available limit",
  "financial.home.addCard": "New card",
  "financial.home.bill": "Bill",
  "financial.home.spendByCategory": "Spending by category",
  "financial.home.noSpend": "No spending this month.",
  "financial.home.category.groceries": "Groceries",
  "financial.home.category.transport": "Transport",
  "financial.home.category.subscriptions": "Subscriptions",
  "financial.home.category.dining": "Dining",
  "financial.home.category.home": "Home",
  "financial.home.category.health": "Health",
  "financial.home.category.leisure": "Leisure",
  "financial.home.category.shopping": "Shopping",
  "financial.home.category.other": "Other",
  ...
  // Settings registry tabs
  "registry.payment-methods": "Payment Methods",
  "registry.payment-methods.description": "Configured payment methods with fees and installment rules",
  "registry.bank-accounts": "Accounts",
  "registry.bank-accounts.description": "Bank accounts, cash registers, credit cards, and digital wallets",
  "registry.chart-of-accounts": "Chart of Accounts",
  "registry.chart-of-accounts.description": "Hierarchical chart of accounts for categorizing transactions",
  "registry.cost-centers": "Cost Centers",
  "registry.cost-centers.description": "Cost centers for expense tracking and departmental budgets",
  "registry.commission-rules": "Commission Rules",
  "registry.commission-rules.description": "Commission rules for service and product revenue sharing",
  "registry.price-tables": "Price Tables",
  "registry.price-tables.description": "Price tables for sale and cost pricing",
  "registry.price-variations": "Price Variations",
  "registry.price-variations.description": "Discount and surcharge rules for pricing",
  "registry.payment-method-types": "Payment Types",
  "registry.payment-method-types.description": "System payment types (cash, card, PIX, etc.)",
  "registry.card-brands": "Card Brands",
  "registry.card-brands.description": "Credit and debit card brands",
  // Statements / extract
  "financial.statements.columnDate": "Date",
  "financial.statements.columnDescription": "Description",
  "financial.statements.columnDebit": "Debit",
  "financial.statements.columnCredit": "Credit",
  "financial.statements.columnFee": "Fee",
  "financial.statements.columnBalance": "Balance",
  "financial.statements.columnMethod": "Method",
  "financial.statements.columnDoc": "Document",
  "financial.statements.installmentShort": "Inst. {{n}}",
  "financial.statements.viewInvoice": "View invoice",
  "financial.person.empty": "No financial activity for this contact yet",
  "financial.statements.opening": "Opening balance",
  "financial.statements.closing": "Closing balance",
  "financial.statements.currentBalance": "Current balance",
  "financial.statements.totalCredits": "Credits",
  "financial.statements.totalDebits": "Debits",
  "financial.statements.totalFees": "Fees",
  "financial.statements.net": "Net",
  "financial.statements.transfer": "Transfer",
  "financial.statements.reconciled": "Reconciled with the bank statement",
  "financial.statements.imported": "Imported from the bank · not reconciled",
  "financial.statements.reconciledWith": "Reconciled with {{ref}}",
  "financial.statements.newTransfer": "New Transfer",
  // Transfer dialog
  "financial.transfer.title": "Transfer Between Accounts",
  "financial.transfer.from": "From account",
  "financial.transfer.to": "To account",
  "financial.transfer.amount": "Amount",
  "financial.transfer.date": "Date",
  "financial.transfer.notes": "Notes",
  "financial.transfer.optionalNotes": "Optional notes...",
  "financial.transfer.selectAccount": "Select account...",
  "financial.transfer.submit": "Transfer",
  "financial.transfer.processing": "Transferring...",
  "financial.transfer.cancel": "Cancel",
  "financial.transfer.created": "Transfer recorded",
  "financial.transfer.failed": "Failed to record transfer",
  "financial.transfer.sameAccount": "Source and destination must differ",
  "financial.transfer.invalidAmount": "Amount must be greater than zero",
  "financial.quickTx.title": "New transaction",
  "financial.quickTx.close": "Close",
  "financial.quickTx.newTransaction": "New transaction",
  "financial.quickTx.expense": "Expense",
  "financial.quickTx.income": "Income",
  "financial.quickTx.transfer": "Transfer",
  "financial.quickTx.paid": "Paid",
  "financial.quickTx.received": "Received",
  "financial.quickTx.yes": "Yes",
  "financial.quickTx.no": "No",
  "financial.quickTx.category": "Category",
  "financial.quickTx.selectCategory": "No category",
  "financial.quickTx.account": "Account",
  "financial.quickTx.selectAccount": "Select account",
  "financial.quickTx.fromAccount": "From account",
  "financial.quickTx.toAccount": "To account",
  "financial.quickTx.card": "Card",
  "financial.quickTx.recurring": "Recurring",
  "financial.quickTx.attachment": "Attachment",
  "financial.quickTx.attachmentSoon": "Attachments coming soon",
  "financial.quickTx.receipt": "Receipt",
  "financial.quickTx.receiptCapture": "Snap or attach a receipt",
  "financial.quickTx.receiptAttached": "Receipt attached",
  "financial.quickTx.receiptReplace": "Replace",
  "financial.quickTx.receiptRemove": "Remove receipt",
  "financial.quickTx.receiptInvalid": "Please choose an image file",
  "financial.quickTx.sendReceipt": "Send receipt",
  "financial.quickTx.descriptionPlaceholder": "e.g. Groceries, Salary…",
  "financial.quickTx.enterAmount": "Enter an amount",
  "financial.quickTx.save": "Save",
  "financial.quickTx.saving": "Saving…",
}
