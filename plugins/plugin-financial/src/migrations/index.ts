...
export const MIGRATION_009_AGENT_RPCS = `-- ============================================================================
...
export const MIGRATION_010_INVOICE_INTERNAL = `-- Financial plugin — separate WHO MAY invoice from HOW an invoice is built.
--
...
export const MIGRATIONS: Array<{ id: string; sql: string }> = [
  ...
  { id: "009_agent_rpcs", sql: MIGRATION_009_AGENT_RPCS },
  { id: "010_invoice_internal", sql: MIGRATION_010_INVOICE_INTERNAL },
]
