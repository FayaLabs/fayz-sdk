...
Last updated: 2026-06-14 19:39 BRT
...
13. M63/M64 route-shell proof is local-gated: `@fayz-ai/saas`, `@fayz-ai/plugin-crm`, and `@fayz-ai/plugin-agenda` gates pass; Beauty/Resto production builds pass; ports 5180/5181/5183/5184/5185/5186 respond 200. Authenticated Beauty QA confirmed `/clients`, client detail click, `/settings`, `/registry/services/new`, and real staff schedule route. `/sales/leads/list` no longer 404s but currently shows CRM onboarding until the user completes/skips setup.
